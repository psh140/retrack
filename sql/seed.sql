...
-- 과제 4건 (APPROVED / REVIEWING / DRAFT / COMPLETED)
...
(2, '빅데이터 분석 플랫폼 구축',      '임상 데이터 통합·분석 플랫폼 설계 및 구현',         'REVIEWING', 3, 2,    '2026-03-01', '2026-09-30', 15000000),
...
(1, 'RESEARCH_ACTIVITY', '서버 구축비',        3000000, 3, '2026-01-20 14:00:00'),
(4, 'PERSONNEL',         '연구원 인건비 전체', 6000000, 4, '2025-12-31 18:00:00'),
(4, 'ETC',               '소모품비',            800000, 4, '2025-06-30 12:00:00');

-- 상태 변경 이력
INSERT INTO project_history (project_id, changed_by, prev_status, new_status, comment) VALUES
(1, 3, 'DRAFT',     'REVIEWING', '연구계획서 제출 완료'),
(1, 2, 'REVIEWING', 'APPROVED',  '예산 및 계획 검토 완료. 승인'),
(2, 3, 'DRAFT',     'REVIEWING', '기획서 제출'),
(4, 4, 'DRAFT',     'REVIEWING', '최종 보고서 제출'),
(4, 2, 'REVIEWING', 'APPROVED',  '검토 완료'),
(4, 2, 'APPROVED',  'COMPLETED', '과제 종료 처리');

-- 알림 (과제 상태 변경 알림)
INSERT INTO notifications (user_id, project_id, message, status, sent_at) VALUES
(3, 1, '[AI 기반 신약 개발 연구] 상태가 DRAFT → REVIEWING 로 변경되었습니다.',        'SENT', '2026-01-10 10:00:00'),
(3, 1, '[AI 기반 신약 개발 연구] 상태가 REVIEWING → APPROVED 로 변경되었습니다.',     'SENT', '2026-01-15 14:00:00'),
(3, 2, '[빅데이터 분석 플랫폼 구축] 상태가 DRAFT → REVIEWING 로 변경되었습니다.',     'SENT', '2026-03-05 09:30:00'),
...
(2, 'CHANGE_STATUS',  'PROJECT', 1,    '과제 상태 변경: REVIEWING → APPROVED');
